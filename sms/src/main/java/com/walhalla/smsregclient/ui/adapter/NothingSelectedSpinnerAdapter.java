...
public class NothingSelectedSpinnerAdapter implements SpinnerAdapter, ListAdapter {
    ...
    public NothingSelectedSpinnerAdapter(
            ...
            int nothingSelectedLayout, Context context, String title) {

        this(spinnerAdapter, nothingSelectedLayout, -1, context, title);
    }
    ...
    protected View getNothingSelectedView(ViewGroup parent) {
        ...
        CheckedTextView tv = view.findViewById(R.id.text1);
        tv.setText(title);
        return view;
    }
